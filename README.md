...
Форма на `contacts.html#form` не отправляет данные на сервер и не пишет в таблицы.
При отправке открывается почтовый клиент пользователя с письмом на `sar.romanchenko@gmail.com`.
Логика — как в ваших проектах site-tilda / HR RADAR.
